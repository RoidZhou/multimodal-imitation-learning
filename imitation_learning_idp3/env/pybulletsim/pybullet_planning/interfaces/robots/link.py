...
from imitation_learning_idp3.env.pybulletsim.pybullet_planning.utils import BASE_LINK, CLIENT
from imitation_learning_idp3.env.pybulletsim.pybullet_planning.interfaces.robots.joint import get_num_joints, get_joints, get_joint_info, is_movable, prune_fixed_joints
...
def get_link_name(body, link):
    from imitation_learning_idp3.env.pybulletsim.pybullet_planning.interfaces.robots.body import get_base_name
    if link == BASE_LINK:
...
def get_relative_pose(body, link1, link2=BASE_LINK):
    ...
    [type]
        [description]
    """
    from imitation_learning_idp3.env.pybulletsim.pybullet_planning.interfaces.env_manager.pose_transformation import multiply, invert
