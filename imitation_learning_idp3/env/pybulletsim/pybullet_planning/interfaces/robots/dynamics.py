...
from imitation_learning_idp3.env.pybulletsim.pybullet_planning.utils import CLIENT, BASE_LINK, STATIC_MASS
...
def set_static(body):
    ...
    body : int
        [description]
    """
    from imitation_learning_idp3.env.pybulletsim.pybullet_planning.interfaces.robots.link import get_all_links
    for link in get_all_links(body):
        set_mass(body, mass=STATIC_MASS, link=link)

def set_all_static():
    from imitation_learning_idp3.env.pybulletsim.pybullet_planning.interfaces.env_manager.simulation import disable_gravity
    from imitation_learning_idp3.env.pybulletsim.pybullet_planning.interfaces.robots.body import get_bodies
    # TODO: mass saver
    disable_gravity()
...
def get_local_link_pose(body, joint):
    from imitation_learning_idp3.env.pybulletsim.pybullet_planning.interfaces.env_manager.pose_transformation import Pose, multiply, invert
    from imitation_learning_idp3.env.pybulletsim.pybullet_planning.interfaces.robots.joint import get_joint_parent_frame
    from imitation_learning_idp3.env.pybulletsim.pybullet_planning.interfaces.robots.link import parent_link_from_joint
