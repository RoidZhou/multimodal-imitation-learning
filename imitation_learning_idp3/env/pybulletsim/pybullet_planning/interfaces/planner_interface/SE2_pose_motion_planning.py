...
from imitation_learning_idp3.env.pybulletsim.pybullet_planning.utils import MAX_DISTANCE, CIRCULAR_LIMITS
from imitation_learning_idp3.env.pybulletsim.pybullet_planning.motion_planners import birrt, direct_path

#####################################
# SE(2) pose motion planning

def get_base_difference_fn():
    from imitation_learning_idp3.env.pybulletsim.pybullet_planning.interfaces.env_manager.pose_transformation import circular_difference
    def fn(q2, q1):
...
def plan_base_motion(body, end_conf, base_limits, obstacles=[], direct=False,
    ...
    from imitation_learning_idp3.env.pybulletsim.pybullet_planning.interfaces.robots.collision import pairwise_collision
    from imitation_learning_idp3.env.pybulletsim.pybullet_planning.interfaces.robots.body import set_base_values, get_base_values
