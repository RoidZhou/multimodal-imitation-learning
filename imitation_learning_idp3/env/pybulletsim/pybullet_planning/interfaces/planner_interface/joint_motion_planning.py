...
from imitation_learning_idp3.env.pybulletsim.pybullet_planning.utils import CIRCULAR_LIMITS, DEFAULT_RESOLUTION, MAX_DISTANCE
from imitation_learning_idp3.env.pybulletsim.pybullet_planning.interfaces.env_manager.pose_transformation import circular_difference, get_unit_vector, convex_combination

from imitation_learning_idp3.env.pybulletsim.pybullet_planning.interfaces.env_manager.user_io import wait_for_user
from imitation_learning_idp3.env.pybulletsim.pybullet_planning.interfaces.debug_utils import add_line
from imitation_learning_idp3.env.pybulletsim.pybullet_planning.interfaces.robots.joint import get_custom_limits, get_joint_positions
from imitation_learning_idp3.env.pybulletsim.pybullet_planning.interfaces.robots.collision import get_collision_fn

from imitation_learning_idp3.env.pybulletsim.pybullet_planning.motion_planners import birrt, lazy_prm
...
def get_difference_fn(body, joints):
    from imitation_learning_idp3.env.pybulletsim.pybullet_planning.interfaces.robots.joint import is_circular
