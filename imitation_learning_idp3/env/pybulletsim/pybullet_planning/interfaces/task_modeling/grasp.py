...
from imitation_learning_idp3.env.pybulletsim.pybullet_planning.utils import CLIENT, BASE_LINK
from imitation_learning_idp3.env.pybulletsim.pybullet_planning.interfaces.env_manager.pose_transformation import multiply, invert, set_pose, get_pose
from imitation_learning_idp3.env.pybulletsim.pybullet_planning.interfaces.robots.link import get_link_subtree, get_link_pose
...
class Attachment(object):
    ...
    @property
    def bodies(self):
        from imitation_learning_idp3.env.pybulletsim.pybullet_planning.interfaces.robots.collision import flatten_links
    ...
    def to_data(self):
        from imitation_learning_idp3.env.pybulletsim.pybullet_planning.interfaces.robots.body import get_body_name, get_name
    ...
    def from_data(cls, data, parent=None, child=None):
        from imitation_learning_idp3.env.pybulletsim.pybullet_planning.interfaces.env_manager.simulation import is_connected
        from imitation_learning_idp3.env.pybulletsim.pybullet_planning.interfaces.robots.body import body_from_name, get_bodies
        from imitation_learning_idp3.env.pybulletsim.pybullet_planning.interfaces.robots.link import link_from_name
        if parent is None:
...
def get_grasp_pose(constraint):
    ...
    [type]
        [description]
    """
    from imitation_learning_idp3.env.pybulletsim.pybullet_planning.interfaces.task_modeling.constraint import get_constraint_info
