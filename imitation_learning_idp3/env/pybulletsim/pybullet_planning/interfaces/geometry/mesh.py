...
from imitation_learning_idp3.env.pybulletsim.pybullet_planning.utils import TEMP_DIR, PI
from imitation_learning_idp3.env.pybulletsim.pybullet_planning.utils import ensure_dir, write, read, safe_zip
...
def create_mesh(mesh, under=True, **kwargs):
    ...
    import sys
    sys.path.append('../../../imitation_learning_idp3')
    from imitation_learning_idp3.env.pybulletsim.pybullet_planning.interfaces.env_manager.shape_creation import create_obj
    ensure_dir(TEMP_DIR)
...
def tform_mesh(affine, mesh):
    from imitation_learning_idp3.env.pybulletsim.pybullet_planning.interfaces.env_manager.pose_transformation import apply_affine
    return Mesh(apply_affine(affine, mesh.vertices), mesh.faces)

def grow_polygon(vertices, radius, n=8):
    from imitation_learning_idp3.env.pybulletsim.pybullet_planning.interfaces.env_manager.pose_transformation import unit_from_theta
