...
def set_camera_pose2(world_from_camera, distance=2):
    from imitation_learning_idp3.env.pybulletsim.pybullet_planning.interfaces.env_manager.pose_transformation import tform_point, point_from_pose
...
def set_default_camera():
    from imitation_learning_idp3.env.pybulletsim.pybullet_planning.interfaces.env_manager.pose_transformation import Point
