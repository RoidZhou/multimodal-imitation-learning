...
class UR5Env:
    ...
    def __init__(self, cfg, render=True):
        ...
        self.ur5_id = p.loadURDF(
            "./assert/ur_description/urdf/ur5_robot_sensor_eelink_circle.urdf",
    ...
    def reset(self):
        ...
        self.hole_up_end[0] = self.obj_t[0] + 0.0329
        self.hole_up_end[1] = self.obj_t[1] - 0.027
        self.hole_up_end[2] = self.obj_t[2] + 0.1145
    ...
    def run(self):
        ...
        time3 = 0.5
        t3 = t2.copy()
        # t3[2] -= 0.0025 # for plot collect data phase contact
        R3 = R2.copy()
